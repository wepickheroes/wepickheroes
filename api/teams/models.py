...
class Team(AbstractBaseModel):
    ...
    regions = models.ManyToManyField('nucleus.Region', related_name='teams', blank=True)
    available_positions = models.ManyToManyField('nucleus.Position', related_name='teams', blank=True)
    interests = models.ManyToManyField('nucleus.Interest', related_name='teams', blank=True)
    languages = models.ManyToManyField('nucleus.Language', related_name='teams', blank=True)
